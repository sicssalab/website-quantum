...
const apiLuumMock = {
    items: [
        ...
        },
        {
            ...
            description: "Departamentos en Riviera Maya con más de 20 exclusivas amenidades como Alberca, Casa Club, Caseta de Seguridad y más.",
            housing: "16",
        ...
        },
        {
            ...
            title: "conoce luum by selva escondida",
            description: "Un residencial de departamentos a solo 8 min. de la playa y a menos de 25 min. de Cancún o Playa del Carmen.",
            items: [
                {
                    alt: 'alt-PathImg',
