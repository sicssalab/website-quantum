...
const response = {
    items: [
        ...
        },
        {
            ...
            description: "Real estate development in CDMX consisting of three condominium towers, with six levels in each building.<br /><br />A new concept of comfort and modern living, thanks to spaces that reflect a contemporary lifestyle.",
            housing: "127",
        ...
        },
        {
            ...
            title: "About venecia residencial",
            description: "Urban design focused on maximizing functionality with top-notch finishes and and first-class equipment.",
            items: [
                {
                    alt: 'alt-PathImg',
