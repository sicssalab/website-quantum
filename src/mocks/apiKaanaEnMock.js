...
const apiKaanaMock = {
    items: [
        ...
        },
        {
            ...
            description: "Condos with terrace and balcony options, with over 20 amenities such as a swimming pool, clubhouse, security booth, multi-purpose court, and more.",
            housing: "30",
        ...
        },
        {
            ...
            title: "About kaana by selva escondida",
            description: "A residential concept centered around well-being and the relaxed lifestyle of the Riviera Maya.",
            items: [
                {
                    alt: 'alt-PathImg',
