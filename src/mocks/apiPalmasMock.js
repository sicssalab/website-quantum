...
const apiPalmasMock = {
    items: [
        ...
        },
        {
            ...
            description: "La perfecta armonía de la exclusividad con la naturaleza a través de un residencial privado de 24 departamentos con más de 10 amenidades en las que destacan Seguridad Privada, Alberca, Gimnasio y Casa Club.",
            housing: "24",
        ...
        },
        {
            ...
            title: "conoce palmas by selva escondida",
            description: "Un residencial de departamentos a solo 8 min. de la playa con más de 10 amenidades.",
            items: [
                {
                    alt: 'alt-PathImg',
